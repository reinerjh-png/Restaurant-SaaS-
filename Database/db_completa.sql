...
(1,1,'Tacacho con Chicharron','Cerdo frito y ensalada criolla',18.00,0,1),
...
(1,1,'Patacon Achorado','Patacones acompañados de cecina, chicharrón y chorizo',25.00,0,1),
...
(1,4,'Combito Amazonico','Juanecito + Tacacho + Chicharrón',16.00,0,1),
(1,4,'Chaufa Lomero','Chaufa + Lomo saltado',30.00,0,1),
(1,4,'Pechuga Achorada','Chaufa + Pechuga al Grill',28.00,0,1),
(1,4,'Trio Amazonico','Cecina + Chicharrón + Chorizo + Guarniciones',45.00,0,1),
(1,4,'Piqueo Amazonico','Chaufa amazónico + Ceviche de dorado + Chicharrón de paiche + Guarniciones',60.00,0,1),
(1,4,'Ronda Amazonica','Juane + Chicharrón + Cecina + Chorizo + Guarniciones',60.00,0,1),
(1,5,'Chaufa Amazonico','Chicharrón + Cecina + Chorizo',24.00,0,1),
...
(1,6,'Tallarin Saltado (Pollo)','Acompañado de patacones y yucas fritas',24.00,0,1),
(1,6,'Tallarin Saltado (Res)','Acompañado de patacones y yucas fritas',26.00,0,1),
(1,6,'Tallarin Saltado Mar y Selva','Cecina, chorizo y langostinos',28.00,0,1),
...
(1,8,'Chicharron de Pollo','Arroz + Papas fritas + Ensalada mixta',27.00,0,1),
...
(1,9,'Chicharron de Dorado','Arroz + Patacones + Yucas fritas + Ensalada',30.00,0,1),
(1,9,'Chicharron de Paiche','Arroz + Patacones + Yucas fritas + Ensalada',30.00,0,1),
...
(1,10,'Ceviche Clasico',NULL,28.00,0,1),
(1,10,'Causa Acevichada',NULL,23.00,0,1),
(1,10,'Arroz con Mariscos',NULL,25.00,0,1),
(1,10,'Chaufa de Mariscos',NULL,20.00,0,1),
(1,10,'Duo Marino','2 platos marinos a elegir',30.00,0,1),
(1,10,'Trio Marino','3 platos marinos a elegir',40.00,0,1),
...
(1,13,'La Clasica','160 gr de carnes seleccionadas, queso cheddar, tocino, lechuga y tomate',15.00,0,1),
...
(1,15,'Super Clasica','Salchicha revueltas con huevo y papas fritas',13.00,0,1),
...
(1,15,'Amazonica','Trozos de cecina y chorizo ahumado, huevo a la inglesa y patacones',20.00,0,1),
...
(1,17,'Porcion de Arroz',NULL,5.00,0,1),
(1,17,'Porcion de Yucas Fritas',NULL,8.00,0,1);
INSERT INTO productos (restaurante_id, categoria_id, nombre, descripcion, precio, tiene_opciones, activo) VALUES
(1,17,'Porcion de Patacones',NULL,8.00,0,1),
(1,17,'Porcion de Maduro Frito',NULL,8.00,0,1),
(1,17,'Porcion de Papas Fritas',NULL,8.00,0,1),
...
(1,20,'1L Maracuya',NULL,18.00,0,1),
(1,20,'½ Maracuya',NULL,9.00,0,1),
...
(1,21,'Te',NULL,3.00,0,1),
(1,21,'Manzanilla',NULL,3.00,0,1),
(1,21,'Anis',NULL,3.00,0,1),
(1,21,'Cafe Pasado',NULL,5.00,0,1),
(1,21,'Cafe con Leche',NULL,7.00,0,1),
...
(1,23,'Sour Clasico',NULL,16.00,0,1),
(1,23,'Sour de Maracuya',NULL,17.00,0,1),
...
(1,24,'Mojito Clasico',NULL,16.00,0,1),
(1,24,'Mojito de Maracuya',NULL,17.00,0,1),
...
(1,25,'Chilcano Clasico',NULL,15.00,0,1),
(1,25,'Chilcano de Maracuya',NULL,16.00,0,1),
...
(1,26,'Margarita Clasico',NULL,17.00,0,1),
